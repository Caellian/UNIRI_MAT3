...
\NewDocumentEnvironment{example}{ o +b }{
    ...
    \IfValueTF{#1}
        {\begin{borderbox}{\faPencil}{Primjer \thesection.\theexamplecounter: #1}{colorexamplefg}{colorexamplebg}}
        {\begin{borderbox}{\faPencil}{Primjer \thesection.\theexamplecounter}{colorexamplefg}{colorexamplebg}}
    #2
}{
    \end{borderbox}
}
...
\NewDocumentEnvironment{definition}{ o +b }{
    ...
    \IfValueTF{#1}
        {\begin{borderbox}{\faInfoCircle}{Definicija \thesection.\thedefinitioncounter: #1}{colordefinitionfg}{colordefinitionbg}}
        {\begin{borderbox}{\faInfoCircle}{Definicija \thesection.\thedefinitioncounter}{colordefinitionfg}{colordefinitionbg}}
    #2
}{
    \end{borderbox}
}
...
\NewDocumentEnvironment{theorem}{ o +b }{
    ...
    \IfValueTF{#1}
        {\begin{borderbox}{\faInfoCircle}{Teorem \thesection.\thetheoremcounter: #1}{colordefinitionfg}{colordefinitionbg}}
        {\begin{borderbox}{\faInfoCircle}{Teorem \thesection.\thetheoremcounter}{colordefinitionfg}{colordefinitionbg}}
    #2
}{
    \end{borderbox}
}
...
\NewDocumentEnvironment{propositionbox}{ o +b }{
    \refstepcounter{propositioncounter} 
    \IfValueTF{#1}
        {\begin{borderbox}{\faInfoCircle}{Propozicija \thesection.\thepropositioncounter: #1}{colordefinitionfg}{colordefinitionbg}}
        {\begin{borderbox}{\faInfoCircle}{Propozicija \thesection.\thepropositioncounter}{colordefinitionfg}{colordefinitionbg}}
    #2
}{
    \end{borderbox}
}
