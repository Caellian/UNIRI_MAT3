...
\NewDocumentEnvironment{propositionbox}{ o +b }{
    ...
    \IfValueTF{#1}
        {\begin{borderbox}{\faInfoCircle}{Propozicija \thepropositioncounter: #1}{colordefinitionfg}{colordefinitionbg}}
        {\begin{borderbox}{\faInfoCircle}{Propozicija \thepropositioncounter}{colordefinitionfg}{colordefinitionbg}}
    #2
}{
    \end{borderbox}
}
